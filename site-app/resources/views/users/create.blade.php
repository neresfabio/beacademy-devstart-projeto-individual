...
<body>
    ...
    <div class="container m-auto p-auto">
        ...
        @endif
        <form action="{{ route('users.store') }}" class="form-signin border border-secondary m-5 p-3 mb-5 rounded"
            style="background-color: #c2c1c1" method="POST">
            @csrf
            <div class="text-center mb-4">
                <h1 class="h3 mb-3 font-weight-normal">Cadastra-se</h1>
                <p>Laravel & PHP</p>
            </div>
            <div class="form-label-group row mb-4">
                <!-- nome -->
                <div class="col-md-4">
