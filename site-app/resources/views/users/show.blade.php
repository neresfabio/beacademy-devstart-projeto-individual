...
<body>
    <div class="container my-4">
        <div class="row row-cols-2 row-cols-lg-3 g-2 g-lg-3 mb-2">
            <div class="col">
            ...
            <div class="col">
                <div class="input-group flex-nowrap">
                    <span class="input-group-text" id="cpf">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col">
                <div class="input-group flex-nowrap">
                    <span class="input-group-text" id="rg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col">
                <div class="input-group flex-nowrap">
                    <span class="input-group-text" id="logradouro">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <input type="text" class="form-control" id="logradouro" name="logradouro"
                        value="{{ $user->logradouro }}" disabled>
                </div>
            </div>
            <div class="col">
                <div class="input-group flex-nowrap">
                    <span class="input-group-text" id="localidade">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <input type="text" class="form-control" id="localidade" name="localidade"
                        value="{{ $user->localidade }}" disabled>
                </div>
            </div>
            <div class="col">
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" id="uf" name="uf"
                        value="{{ $user->uf }}" disabled>
                </div>
            </div>
        </div>
        <div class="btn-group">
            <a href="{{ route('users.edit', $user->id) }}" class="btn btn-outline-dark rounded me-2 active"
                aria-current="page">Editar</a>
                <form action="{{ route('users.destroy', $user->id) }}" method="post">
                    @method('DELETE')
                    @csrf
                    <button type="submit" class="btn btn-outline-dark rounded me-2">Excluir</button>
            </form>
            <a href="{{ route('users.index') }}" class="btn btn-outline-dark rounded">Cancelar</a>
        </div>
    </div>
